...
public class RevOpMode extends LinearOpMode
{
  ...
  protected final void Init() throws InterruptedException
  {
	...
	_player = MediaPlayer.create( hardwareMap.appContext, Uri.fromFile(
  ...
  public void AutoDrive(float power, float inches) throws InterruptedException
  {
    ...
    float ticks = (Reference.ENCODER_TICKS_PER_REVOLUTION /
                   Reference.WHEEL_CIRCUMFERENCE) *
                  inches;
  ...
  public static void SetAppContext(Context context) { CONTEXT = context; }
